...
public class BusinessCollectionOperation {
	...
	public BusinessCollectionOperation() {
		...
		List<Review> reviewList1 = Arrays.asList(
				new Review("Arun", 4, "Good"),
				new Review("Basu", 2, "Not good"),
				new Review("Chaitra", 4, "Good"));
		List<Review> reviewList2 = Arrays.asList(
				new Review("Akshata", 5, "Good"),
				new Review("Bindu", 1, "Not good"),
				new Review("Chandana", 3, "Good"),
				new Review("Devid", 4, "very Good"),
				new Review("Ravi", 5, "nice"));
		
		List<Review> reviewList3 = Arrays.asList(
				new Review("Amith", 4, "Good"),
				new Review("Baghya", 1, "Not good"));
		
		
		allFoods.add(new Food("Masala Rice",150,Type.VEG,"Indian",reviewList1));
		allFoods.add(new Food("Veg Noodles",200,Type.VEG,"Asian",reviewList2));
		allFoods.add(new Food("Dosa",100,Type.VEG,"Indian",reviewList2));
		...
		allFoods.add(new Food("Pizza",250,Type.VEG,"Middle East",reviewList3));
		allFoods.add(new Food("Farm House Pizza",550,Type.VEG,"Italian",reviewList3));
		allFoods.add(new Food("French Fries",400,Type.VEG,"Europe",reviewList3));
		
		allFoods.add(new Food("Chicken ",320,Type.NON_VEG,"Indian",reviewList2));
		...
		allFoods.add(new Food("Chicken Kabab",820,Type.NON_VEG,"Middle East",reviewList2));
