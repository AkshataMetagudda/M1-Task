...
public class BusinessOperation {
	...
	public BusinessOperation() {
		...
		allFoods.add(new Food("Masala Rice",100,Type.VEG,"Indian",reviewList1));
		allFoods.add(new Food("Gobi65",120,Type.VEG,"Asian",reviewList2));
		allFoods.add(new Food("SouthIndian Tali",180,Type.VEG,"Indian",reviewList2));
		...
		allFoods.add(new Food("Chicken Biryani",300,Type.NON_VEG,"Indian",reviewList2));
		allFoods.add(new Food("Fish Curry",450,Type.NON_VEG,"Indian",reviewList1));
		allFoods.add(new Food("Chicken Kabab",350,Type.NON_VEG,"Italian",reviewList3));
